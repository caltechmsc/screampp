...
mod tests {
    ...
    fn builder_creates_system_with_single_chain_residue_and_atom() {
        ...
        builder
            ...
            .start_residue(1, "GLY")
            .add_atom(100, "CA", Point3::new(1.0, 2.0, 3.0), 0.0, "C.3");
    ...
    fn builder_adds_multiple_chains_and_residues() {
        ...
        builder
            .start_chain('A', ChainType::Protein)
            .start_residue(1, "GLY")
            .add_atom(1, "CA", Point3::new(0.0, 0.0, 0.0), 0.0, "C.3")
            .start_residue(2, "ALA")
            .add_atom(2, "CB", Point3::new(1.0, 0.0, 0.0), 0.0, "C.3")
            .start_chain('B', ChainType::DNA)
            .start_residue(1, "DA")
            .add_atom(3, "N1", Point3::new(0.0, 1.0, 0.0), 0.0, "N.1");
        let system = builder.build();
    ...
    fn builder_adds_bond_between_atoms_by_serial() {
        ...
        builder
            .start_chain('A', ChainType::Protein)
            .start_residue(1, "GLY")
            .add_atom(10, "CA", Point3::new(0.0, 0.0, 0.0), 0.0, "C.3")
            .add_atom(11, "CB", Point3::new(1.0, 0.0, 0.0), 0.0, "C.3")
    ...
    fn get_atom_and_chain_by_index_and_id() {
        ...
        builder
            ...
            .start_residue(5, "UNK")
            .add_atom(42, "X", Point3::new(0.0, 0.0, 0.0), 0.0, "X");
        let system = builder.build();
    ...
    fn add_atom_without_chain_panics() {
        let mut builder = MolecularSystemBuilder::new();
        builder.add_atom(1, "CA", Point3::new(0.0, 0.0, 0.0), 0.0, "C.3");
    }
